    ...
    lockOverlay.innerHTML = `
      <div style="background: rgba(255,255,255,0.03); backdrop-filter: blur(10px); padding: 40px; border-radius: 16px; border: 1px solid rgba(255,255,255,0.05); max-width: 450px; width: 90%; text-align: center; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5);">
        ...
        <div style="border-top: 1px solid rgba(255,255,255,0.1); padding-top: 25px; margin-top: 15px;">
          ...
          <a href="mailto:lotfi@bahloul-rd.com?subject=Demande%20d%27acc%C3%A8s%20-%20Observatoire%20B%C3%A9ja%C3%AFa&body=Bonjour%20Dr.%20Bahloul%2C%0D%0A%0D%0AJe%20souhaite%20obtenir%20un%20code%20d%27acc%C3%A8s%20pour%20consulter%20la%20plateforme%20de%20l%27Observatoire%20Territorial.%0D%0A%0D%0ANom%20%3A%20%0D%0AInstitution%2FEntreprise%20%3A%20%0D%0AEmail%20%3A%20%0D%0AT%C3%A9l%C3%A9phone%20%3A%20%0D%0AMotif%20%3A%20" style="display: inline-block; padding: 10px 20px; background: rgba(255,255,255,0.05); color: white; text-decoration: none; font-size: 0.9rem; font-weight: 600; border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); transition: all 0.2s;"><i class="fas fa-envelope" style="margin-right: 8px; color: #38bdf8;"></i> Demander l'accès</a>
        </div>
      </div>
    `;
